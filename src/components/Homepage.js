...
<div className="App w-full overflow-x-hidden">
  ...
  {/* Hero Section */}
  <div className="relative h-[80vh] w-full overflow-hidden bg-gray-900 pt-20"> {/* Adjusted height and added padding-top */}
    ...
    <div className="relative max-w-7xl mx-auto px-4">
      <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center"> {/* Adjusted gap */}
        ...
        <div className="relative w-full max-w-xs mx-auto md:max-w-full"> {/* Responsive adjustments */}
          ...
          <div className="absolute -top-4 -left-4 w-16 h-16 md:w-24 md:h-24 border-l-2 border-t-2 border-yellow-500/30" /> {/* Adjusted sizes */}
